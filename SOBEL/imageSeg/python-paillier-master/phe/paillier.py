...
def generate_paillier_keypair_1(p, q):
    """Return a new :class:`PaillierPublicKey` and :class:`PaillierPrivateKey`.
...
class PaillierPublicKey(object):
    ...
    def encrypt_pre(self, plaintext, r_n_n):
        ...
        temp = (nude_ciphertext * r_n_n) % self.nsquare
        encoding = EncodedNumber.encode(self, temp, None)   
        self.encrypt_encoded(encoding, None)    
